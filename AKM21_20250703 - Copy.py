...
url3 ='http://192.168.7.126:1800/api/glucose' #endpoint web cemti
...
try:
    while True:
        ...
        print(f"Gula: {Gula:.2f} | Berat: {bleScale} Kg | Tinggi: {Tinggi*1.051:.2f} cm | Tensi: {bleSys}/{bleDias} | Pulse: {bleBPM} bpm")
