...
async def monitor_device(device_name: str, address: str, char_uuid: str, parser_func: callable):
    ...
    while True:
        try:
            ...
            if not device:
                print(f"[BLE Thread] {device_name} tidak ditemukan. Mencoba lagi dalam 10 detik...")
...
try:
    while True:
        ...
        print(f"Gula: {Gula:.2f} | Berat: {bleScale} Kg | Tinggi: {Tinggi:.2f} cm | Tensi: {bleSys}/{bleDias} | Pulse: {bleBPM} bpm")
